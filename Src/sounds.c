...
void    pause(uint16_t ms)
{
    ...
    delayMillis(ms);
    SET_DUTY_CYCLE_ALL(beep_volume); // volume of the beep, (duty cycle) don't
...
{ // hz and ms
    ...
    SET_DUTY_CYCLE_ALL(beep_volume * timerOne_reload /
                       TIM1_AUTORELOAD); // volume of the beep, (duty cycle)
                                         // don't go above 25 out of 2000
